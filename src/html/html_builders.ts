...
import { Doctype, HTMLDocument, VoidBaseHTMLElement, createHTMLElement } from "./html_element.js";
...
function aElement(
	...
	return createHTMLElement<"a", ATTRIBUTE_MAP["a"], CHILDREN_MAP["a"]>("a", attrsOrChild, children);
}
...
function abbrElement(
	...
	return createHTMLElement<"abbr", ATTRIBUTE_MAP["abbr"], CHILDREN_MAP["abbr"]>("abbr", attrsOrChild, children);
}

function addressElement(...children: Array<CHILDREN_MAP["address"]>): ELEMENT_MAP["address"];
function addressElement(
	attributes: ATTRIBUTE_MAP["address"],
...
function articleElement(
	attributes: ATTRIBUTE_MAP["article"],
...
function asideElement(
	attributes: ATTRIBUTE_MAP["aside"],
...
function asideElement(
	...
	return createHTMLElement<"aside", ATTRIBUTE_MAP["aside"], CHILDREN_MAP["aside"]>("aside", attrsOrChild, children);
}

function audioElement(...children: Array<CHILDREN_MAP["audio"]>): ELEMENT_MAP["audio"];
function audioElement(
	attributes: ATTRIBUTE_MAP["audio"],
...
function audioElement(
	...
	return createHTMLElement<"audio", ATTRIBUTE_MAP["audio"], CHILDREN_MAP["audio"]>("audio", attrsOrChild, children);
}
...
function bElement(
	...
	return createHTMLElement<"b", ATTRIBUTE_MAP["b"], CHILDREN_MAP["b"]>("b", attrsOrChild, children);
}
...
function bdiElement(
	...
	return createHTMLElement<"bdi", ATTRIBUTE_MAP["bdi"], CHILDREN_MAP["bdi"]>("bdi", attrsOrChild, children);
}
...
function bdoElement(
	...
	return createHTMLElement<"bdo", ATTRIBUTE_MAP["bdo"], CHILDREN_MAP["bdo"]>("bdo", attrsOrChild, children);
}

function blockquoteElement(...children: Array<CHILDREN_MAP["blockquote"]>): ELEMENT_MAP["blockquote"];
function blockquoteElement(
	attributes: ATTRIBUTE_MAP["blockquote"],
...
function bodyElement(
	...
	return createHTMLElement<"body", ATTRIBUTE_MAP["body"], CHILDREN_MAP["body"]>("body", attrsOrChild, children);
}
...
function buttonElement(
	attributes: ATTRIBUTE_MAP["button"],
...
function buttonElement(
	...
	return createHTMLElement<"button", ATTRIBUTE_MAP["button"], CHILDREN_MAP["button"]>("button", attrsOrChild, children);
}

function canvasElement(...children: Array<CHILDREN_MAP["canvas"]>): ELEMENT_MAP["canvas"];
function canvasElement(
	attributes: ATTRIBUTE_MAP["canvas"],
...
function canvasElement(
	...
	return createHTMLElement<"canvas", ATTRIBUTE_MAP["canvas"], CHILDREN_MAP["canvas"]>("canvas", attrsOrChild, children);
}

function captionElement(...children: Array<CHILDREN_MAP["caption"]>): ELEMENT_MAP["caption"];
function captionElement(
	attributes: ATTRIBUTE_MAP["caption"],
...
function citeElement(
	...
	return createHTMLElement<"cite", ATTRIBUTE_MAP["cite"], CHILDREN_MAP["cite"]>("cite", attrsOrChild, children);
}
...
function codeElement(
	...
	return createHTMLElement<"code", ATTRIBUTE_MAP["code"], CHILDREN_MAP["code"]>("code", attrsOrChild, children);
}
...
function colgroupElement(
	attributes: ATTRIBUTE_MAP["colgroup"],
...
function dataElement(
	...
	return createHTMLElement<"data", ATTRIBUTE_MAP["data"], CHILDREN_MAP["data"]>("data", attrsOrChild, children);
}

function datalistElement(...children: Array<CHILDREN_MAP["datalist"]>): ELEMENT_MAP["datalist"];
function datalistElement(
	attributes: ATTRIBUTE_MAP["datalist"],
...
function ddElement(
	...
	return createHTMLElement<"dd", ATTRIBUTE_MAP["dd"], CHILDREN_MAP["dd"]>("dd", attrsOrChild, children);
}
...
function delElement(
	...
	return createHTMLElement<"del", ATTRIBUTE_MAP["del"], CHILDREN_MAP["del"]>("del", attrsOrChild, children);
}

function detailsElement(...children: Array<CHILDREN_MAP["details"]>): ELEMENT_MAP["details"];
function detailsElement(
	attributes: ATTRIBUTE_MAP["details"],
...
function dfnElement(
	...
	return createHTMLElement<"dfn", ATTRIBUTE_MAP["dfn"], CHILDREN_MAP["dfn"]>("dfn", attrsOrChild, children);
}

function dialogElement(...children: Array<CHILDREN_MAP["dialog"]>): ELEMENT_MAP["dialog"];
function dialogElement(
	attributes: ATTRIBUTE_MAP["dialog"],
...
function dialogElement(
	...
	return createHTMLElement<"dialog", ATTRIBUTE_MAP["dialog"], CHILDREN_MAP["dialog"]>("dialog", attrsOrChild, children);
}
...
function divElement(
	...
	return createHTMLElement<"div", ATTRIBUTE_MAP["div"], CHILDREN_MAP["div"]>("div", attrsOrChild, children);
}
...
function dlElement(
	...
	return createHTMLElement<"dl", ATTRIBUTE_MAP["dl"], CHILDREN_MAP["dl"]>("dl", attrsOrChild, children);
}
...
function dtElement(
	...
	return createHTMLElement<"dt", ATTRIBUTE_MAP["dt"], CHILDREN_MAP["dt"]>("dt", attrsOrChild, children);
}
...
function emElement(
	...
	return createHTMLElement<"em", ATTRIBUTE_MAP["em"], CHILDREN_MAP["em"]>("em", attrsOrChild, children);
}
...
function fieldsetElement(
	attributes: ATTRIBUTE_MAP["fieldset"],
...
function figcaptionElement(
	attributes: ATTRIBUTE_MAP["figcaption"],
...
function figureElement(
	attributes: ATTRIBUTE_MAP["figure"],
...
function figureElement(
	...
	return createHTMLElement<"figure", ATTRIBUTE_MAP["figure"], CHILDREN_MAP["figure"]>("figure", attrsOrChild, children);
}

function footerElement(...children: Array<CHILDREN_MAP["footer"]>): ELEMENT_MAP["footer"];
function footerElement(
	attributes: ATTRIBUTE_MAP["footer"],
...
function footerElement(
	...
	return createHTMLElement<"footer", ATTRIBUTE_MAP["footer"], CHILDREN_MAP["footer"]>("footer", attrsOrChild, children);
}
...
function formElement(
	...
	return createHTMLElement<"form", ATTRIBUTE_MAP["form"], CHILDREN_MAP["form"]>("form", attrsOrChild, children);
}
...
function h1Element(
	...
	return createHTMLElement<"h1", ATTRIBUTE_MAP["h1"], CHILDREN_MAP["h1"]>("h1", attrsOrChild, children);
}
...
function h2Element(
	...
	return createHTMLElement<"h2", ATTRIBUTE_MAP["h2"], CHILDREN_MAP["h2"]>("h2", attrsOrChild, children);
}
...
function h3Element(
	...
	return createHTMLElement<"h3", ATTRIBUTE_MAP["h3"], CHILDREN_MAP["h3"]>("h3", attrsOrChild, children);
}
...
function h4Element(
	...
	return createHTMLElement<"h4", ATTRIBUTE_MAP["h4"], CHILDREN_MAP["h4"]>("h4", attrsOrChild, children);
}
...
function h5Element(
	...
	return createHTMLElement<"h5", ATTRIBUTE_MAP["h5"], CHILDREN_MAP["h5"]>("h5", attrsOrChild, children);
}
...
function h6Element(
	...
	return createHTMLElement<"h6", ATTRIBUTE_MAP["h6"], CHILDREN_MAP["h6"]>("h6", attrsOrChild, children);
}
...
function headElement(
	...
	return createHTMLElement<"head", ATTRIBUTE_MAP["head"], CHILDREN_MAP["head"]>("head", attrsOrChild, children);
}

function headerElement(...children: Array<CHILDREN_MAP["header"]>): ELEMENT_MAP["header"];
function headerElement(
	attributes: ATTRIBUTE_MAP["header"],
...
function headerElement(
	...
	return createHTMLElement<"header", ATTRIBUTE_MAP["header"], CHILDREN_MAP["header"]>("header", attrsOrChild, children);
}

function hgroupElement(...children: Array<CHILDREN_MAP["hgroup"]>): ELEMENT_MAP["hgroup"];
function hgroupElement(
	attributes: ATTRIBUTE_MAP["hgroup"],
...
function hgroupElement(
	...
	return createHTMLElement<"hgroup", ATTRIBUTE_MAP["hgroup"], CHILDREN_MAP["hgroup"]>("hgroup", attrsOrChild, children);
}
...
function htmlElement(
	...
	return createHTMLElement<"html", ATTRIBUTE_MAP["html"], CHILDREN_MAP["html"]>("html", attrsOrChild, children);
}
...
function iElement(
	...
	return createHTMLElement<"i", ATTRIBUTE_MAP["i"], CHILDREN_MAP["i"]>("i", attrsOrChild, children);
}

function iframeElement(...children: Array<CHILDREN_MAP["iframe"]>): ELEMENT_MAP["iframe"];
function iframeElement(
	attributes: ATTRIBUTE_MAP["iframe"],
...
function iframeElement(
	...
	return createHTMLElement<"iframe", ATTRIBUTE_MAP["iframe"], CHILDREN_MAP["iframe"]>("iframe", attrsOrChild, children);
}
...
function insElement(
	...
	return createHTMLElement<"ins", ATTRIBUTE_MAP["ins"], CHILDREN_MAP["ins"]>("ins", attrsOrChild, children);
}
...
function kbdElement(
	...
	return createHTMLElement<"kbd", ATTRIBUTE_MAP["kbd"], CHILDREN_MAP["kbd"]>("kbd", attrsOrChild, children);
}

function labelElement(...children: Array<CHILDREN_MAP["label"]>): ELEMENT_MAP["label"];
function labelElement(
	attributes: ATTRIBUTE_MAP["label"],
...
function labelElement(
	...
	return createHTMLElement<"label", ATTRIBUTE_MAP["label"], CHILDREN_MAP["label"]>("label", attrsOrChild, children);
}

function legendElement(...children: Array<CHILDREN_MAP["legend"]>): ELEMENT_MAP["legend"];
function legendElement(
	attributes: ATTRIBUTE_MAP["legend"],
...
function legendElement(
	...
	return createHTMLElement<"legend", ATTRIBUTE_MAP["legend"], CHILDREN_MAP["legend"]>("legend", attrsOrChild, children);
}
...
function liElement(
	...
	return createHTMLElement<"li", ATTRIBUTE_MAP["li"], CHILDREN_MAP["li"]>("li", attrsOrChild, children);
}
...
function mainElement(
	...
	return createHTMLElement<"main", ATTRIBUTE_MAP["main"], CHILDREN_MAP["main"]>("main", attrsOrChild, children);
}
...
function mapElement(
	...
	return createHTMLElement<"map", ATTRIBUTE_MAP["map"], CHILDREN_MAP["map"]>("map", attrsOrChild, children);
}
...
function markElement(
	...
	return createHTMLElement<"mark", ATTRIBUTE_MAP["mark"], CHILDREN_MAP["mark"]>("mark", attrsOrChild, children);
}
...
function mathElement(
	...
	return createHTMLElement<"math", ATTRIBUTE_MAP["math"], CHILDREN_MAP["math"]>("math", attrsOrChild, children);
}
...
function menuElement(
	...
	return createHTMLElement<"menu", ATTRIBUTE_MAP["menu"], CHILDREN_MAP["menu"]>("menu", attrsOrChild, children);
}
...
function meterElement(
	attributes: ATTRIBUTE_MAP["meter"],
...
function meterElement(
	...
	return createHTMLElement<"meter", ATTRIBUTE_MAP["meter"], CHILDREN_MAP["meter"]>("meter", attrsOrChild, children);
}
...
function navElement(
	...
	return createHTMLElement<"nav", ATTRIBUTE_MAP["nav"], CHILDREN_MAP["nav"]>("nav", attrsOrChild, children);
}

function noscriptElement(...children: Array<CHILDREN_MAP["noscript"]>): ELEMENT_MAP["noscript"];
function noscriptElement(
	attributes: ATTRIBUTE_MAP["noscript"],
...
function objectElement(
	attributes: ATTRIBUTE_MAP["object"],
...
function objectElement(
	...
	return createHTMLElement<"object", ATTRIBUTE_MAP["object"], CHILDREN_MAP["object"]>("object", attrsOrChild, children);
}
...
function olElement(
	...
	return createHTMLElement<"ol", ATTRIBUTE_MAP["ol"], CHILDREN_MAP["ol"]>("ol", attrsOrChild, children);
}

function optgroupElement(...children: Array<CHILDREN_MAP["optgroup"]>): ELEMENT_MAP["optgroup"];
function optgroupElement(
	attributes: ATTRIBUTE_MAP["optgroup"],
...
function optionElement(
	...
	return createHTMLElement<"option", ATTRIBUTE_MAP["option"], CHILDREN_MAP["option"]>("option", attrsOrChild, children);
}

function outputElement(...children: Array<CHILDREN_MAP["output"]>): ELEMENT_MAP["output"];
function outputElement(
	attributes: ATTRIBUTE_MAP["output"],
...
function outputElement(
	...
	return createHTMLElement<"output", ATTRIBUTE_MAP["output"], CHILDREN_MAP["output"]>("output", attrsOrChild, children);
}
...
function pElement(
	...
	return createHTMLElement<"p", ATTRIBUTE_MAP["p"], CHILDREN_MAP["p"]>("p", attrsOrChild, children);
}

function pictureElement(...children: Array<CHILDREN_MAP["picture"]>): ELEMENT_MAP["picture"];
function pictureElement(
	attributes: ATTRIBUTE_MAP["picture"],
...
function portalElement(
	attributes: ATTRIBUTE_MAP["portal"],
...
function portalElement(
	...
	return createHTMLElement<"portal", ATTRIBUTE_MAP["portal"], CHILDREN_MAP["portal"]>("portal", attrsOrChild, children);
}
...
function preElement(
	...
	return createHTMLElement<"pre", ATTRIBUTE_MAP["pre"], CHILDREN_MAP["pre"]>("pre", attrsOrChild, children);
}

function progressElement(...children: Array<CHILDREN_MAP["progress"]>): ELEMENT_MAP["progress"];
function progressElement(
	attributes: ATTRIBUTE_MAP["progress"],
...
function qElement(
	...
	return createHTMLElement<"q", ATTRIBUTE_MAP["q"], CHILDREN_MAP["q"]>("q", attrsOrChild, children);
}
...
function rpElement(
	...
	return createHTMLElement<"rp", ATTRIBUTE_MAP["rp"], CHILDREN_MAP["rp"]>("rp", attrsOrChild, children);
}
...
function rtElement(
	...
	return createHTMLElement<"rt", ATTRIBUTE_MAP["rt"], CHILDREN_MAP["rt"]>("rt", attrsOrChild, children);
}
...
function rubyElement(
	...
	return createHTMLElement<"ruby", ATTRIBUTE_MAP["ruby"], CHILDREN_MAP["ruby"]>("ruby", attrsOrChild, children);
}
...
function sElement(
	...
	return createHTMLElement<"s", ATTRIBUTE_MAP["s"], CHILDREN_MAP["s"]>("s", attrsOrChild, children);
}
...
function sampElement(
	...
	return createHTMLElement<"samp", ATTRIBUTE_MAP["samp"], CHILDREN_MAP["samp"]>("samp", attrsOrChild, children);
}

function scriptElement(...children: Array<CHILDREN_MAP["script"]>): ELEMENT_MAP["script"];
function scriptElement(
	attributes: ATTRIBUTE_MAP["script"],
...
function scriptElement(
	...
	return createHTMLElement<"script", ATTRIBUTE_MAP["script"], CHILDREN_MAP["script"]>("script", attrsOrChild, children);
}

function searchElement(...children: Array<CHILDREN_MAP["search"]>): ELEMENT_MAP["search"];
function searchElement(
	attributes: ATTRIBUTE_MAP["search"],
...
function searchElement(
	...
	return createHTMLElement<"search", ATTRIBUTE_MAP["search"], CHILDREN_MAP["search"]>("search", attrsOrChild, children);
}

function sectionElement(...children: Array<CHILDREN_MAP["section"]>): ELEMENT_MAP["section"];
function sectionElement(
	attributes: ATTRIBUTE_MAP["section"],
...
function selectElement(
	attributes: ATTRIBUTE_MAP["select"],
...
function selectElement(
	...
	return createHTMLElement<"select", ATTRIBUTE_MAP["select"], CHILDREN_MAP["select"]>("select", attrsOrChild, children);
}
...
function slotElement(
	...
	return createHTMLElement<"slot", ATTRIBUTE_MAP["slot"], CHILDREN_MAP["slot"]>("slot", attrsOrChild, children);
}

function smallElement(...children: Array<CHILDREN_MAP["small"]>): ELEMENT_MAP["small"];
function smallElement(
	attributes: ATTRIBUTE_MAP["small"],
...
function smallElement(
	...
	return createHTMLElement<"small", ATTRIBUTE_MAP["small"], CHILDREN_MAP["small"]>("small", attrsOrChild, children);
}
...
function spanElement(
	...
	return createHTMLElement<"span", ATTRIBUTE_MAP["span"], CHILDREN_MAP["span"]>("span", attrsOrChild, children);
}

function strongElement(...children: Array<CHILDREN_MAP["strong"]>): ELEMENT_MAP["strong"];
function strongElement(
	attributes: ATTRIBUTE_MAP["strong"],
...
function strongElement(
	...
	return createHTMLElement<"strong", ATTRIBUTE_MAP["strong"], CHILDREN_MAP["strong"]>("strong", attrsOrChild, children);
}

function styleElement(...children: Array<CHILDREN_MAP["style"]>): ELEMENT_MAP["style"];
function styleElement(
	attributes: ATTRIBUTE_MAP["style"],
...
function styleElement(
	...
	return createHTMLElement<"style", ATTRIBUTE_MAP["style"], CHILDREN_MAP["style"]>("style", attrsOrChild, children);
}
...
function subElement(
	...
	return createHTMLElement<"sub", ATTRIBUTE_MAP["sub"], CHILDREN_MAP["sub"]>("sub", attrsOrChild, children);
}

function summaryElement(...children: Array<CHILDREN_MAP["summary"]>): ELEMENT_MAP["summary"];
function summaryElement(
	attributes: ATTRIBUTE_MAP["summary"],
...
function supElement(
	...
	return createHTMLElement<"sup", ATTRIBUTE_MAP["sup"], CHILDREN_MAP["sup"]>("sup", attrsOrChild, children);
}
...
function svgElement(
	...
	return createHTMLElement<"svg", ATTRIBUTE_MAP["svg"], CHILDREN_MAP["svg"]>("svg", attrsOrChild, children);
}

function tableElement(...children: Array<CHILDREN_MAP["table"]>): ELEMENT_MAP["table"];
function tableElement(
	attributes: ATTRIBUTE_MAP["table"],
...
function tableElement(
	...
	return createHTMLElement<"table", ATTRIBUTE_MAP["table"], CHILDREN_MAP["table"]>("table", attrsOrChild, children);
}

function tbodyElement(...children: Array<CHILDREN_MAP["tbody"]>): ELEMENT_MAP["tbody"];
function tbodyElement(
	attributes: ATTRIBUTE_MAP["tbody"],
...
function tbodyElement(
	...
	return createHTMLElement<"tbody", ATTRIBUTE_MAP["tbody"], CHILDREN_MAP["tbody"]>("tbody", attrsOrChild, children);
}
...
function tdElement(
	...
	return createHTMLElement<"td", ATTRIBUTE_MAP["td"], CHILDREN_MAP["td"]>("td", attrsOrChild, children);
}

function templateElement(...children: Array<CHILDREN_MAP["template"]>): ELEMENT_MAP["template"];
function templateElement(
	attributes: ATTRIBUTE_MAP["template"],
...
function textareaElement(
	attributes: ATTRIBUTE_MAP["textarea"],
...
function tfootElement(
	attributes: ATTRIBUTE_MAP["tfoot"],
...
function tfootElement(
	...
	return createHTMLElement<"tfoot", ATTRIBUTE_MAP["tfoot"], CHILDREN_MAP["tfoot"]>("tfoot", attrsOrChild, children);
}
...
function thElement(
	...
	return createHTMLElement<"th", ATTRIBUTE_MAP["th"], CHILDREN_MAP["th"]>("th", attrsOrChild, children);
}

function theadElement(...children: Array<CHILDREN_MAP["thead"]>): ELEMENT_MAP["thead"];
function theadElement(
	attributes: ATTRIBUTE_MAP["thead"],
...
function theadElement(
	...
	return createHTMLElement<"thead", ATTRIBUTE_MAP["thead"], CHILDREN_MAP["thead"]>("thead", attrsOrChild, children);
}
...
function timeElement(
	...
	return createHTMLElement<"time", ATTRIBUTE_MAP["time"], CHILDREN_MAP["time"]>("time", attrsOrChild, children);
}

function titleElement(...children: Array<CHILDREN_MAP["title"]>): ELEMENT_MAP["title"];
function titleElement(
	attributes: ATTRIBUTE_MAP["title"],
...
function titleElement(
	...
	return createHTMLElement<"title", ATTRIBUTE_MAP["title"], CHILDREN_MAP["title"]>("title", attrsOrChild, children);
}
...
function trElement(
	...
	return createHTMLElement<"tr", ATTRIBUTE_MAP["tr"], CHILDREN_MAP["tr"]>("tr", attrsOrChild, children);
}
...
function uElement(
	...
	return createHTMLElement<"u", ATTRIBUTE_MAP["u"], CHILDREN_MAP["u"]>("u", attrsOrChild, children);
}
...
function ulElement(
	...
	return createHTMLElement<"ul", ATTRIBUTE_MAP["ul"], CHILDREN_MAP["ul"]>("ul", attrsOrChild, children);
}
...
function varElement(
	...
	return createHTMLElement<"var", ATTRIBUTE_MAP["var"], CHILDREN_MAP["var"]>("var", attrsOrChild, children);
}

function videoElement(...children: Array<CHILDREN_MAP["video"]>): ELEMENT_MAP["video"];
function videoElement(
	attributes: ATTRIBUTE_MAP["video"],
...
function videoElement(
	...
	return createHTMLElement<"video", ATTRIBUTE_MAP["video"], CHILDREN_MAP["video"]>("video", attrsOrChild, children);
}
